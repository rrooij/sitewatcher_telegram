...
class PepperWatcher(Watcher):
    ...
    def parse_site(self):
        ...
        self.url = "https://nl.pepper.com/search?q={0}".format(self.search_keyword)
    ...
    def check_price_error(self):
        ...
        message_text = 'Zoekterm: {0} | *PRIJSFOUT GEVONDEN OP PEPPER*: {1} URL: {2}'.format(self.search_keyword, articles, self.url)
